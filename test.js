...
VillageState.random = function (parcelCount = 5) {
    ...
    return new VillageState(RandomPick(places), parcels);
}
...
function runRobot(state, robot, memory) {
    for (let turn = 0; ; turn++) {
        ...
        state = state.moveBy(action.direction);
...
function compareRobots(robot1, memory1, robot2, memory2) {
    ...
    console.log(`Average steps for Robot 1: ${total1 / numTests}`);
    console.log(`Average steps for Robot 2: ${total2 / numTests}`);
}
